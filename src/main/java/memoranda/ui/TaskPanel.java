...
//        parentPanel.updateIndicators();
    ...
    // Feature Envy, of method called on taskTable
    void listSubTasks_actionPerformed(ActionEvent e) {
        // TASK 2-2 SMELL BETWEEN CLASSES
        // was String parentTaskId = taskTable.getModel().getValueAt(taskTable.getSelectedRow(), TaskTable.TASK_ID).toString()
        // now is
        String parentTaskId = taskTable.getParentTaskId();
